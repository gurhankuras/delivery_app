...
class SendPackageConfirmationPage extends StatelessWidget {
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: SingleChildScrollView(
          child: BlocProvider(
            create: (context) => getIt<ConfirmOrderBloc>(),
            child: BlocListener<ConfirmOrderBloc, ConfirmOrderState>(
              listener: (context, state) {
                state.maybeMap(
                  ...
                  pdfRequested: (state) {
                    getIt<PdfService>().openFile(state.receipt);
                  },
                  orElse: () {},
                );
              },
  ...
  Widget buildBody(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        SenderReceiverSection(order: getIt<OrderFormData>().order!),
  ...
  Widget buildPackageDetails(BuildContext context) {
    final order = getIt<OrderFormData>().order;
    return Padding(
