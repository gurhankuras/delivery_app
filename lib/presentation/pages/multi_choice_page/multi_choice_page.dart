...
import '../../order/update_order/edit_order_search_page/edit_order_search_page.dart';

class MultiChoicePage extends StatelessWidget {
  void _navigateToEditOrderPage(BuildContext context) {
    Navigator.of(context).push(
      MaterialPageRoute(
        builder: (context) => EditOrderSearchPage(),
      ),
    );
  }
      ...
      child: Column(
        ...
        children: [
          ...
          Expanded(
            flex: 45,
            child: ButtonCard(
              title: LocaleKeys.edit_order_status.tr(),
          ...
          Expanded(
            flex: 45,
            child: ButtonCard(
              title: LocaleKeys.send_package.tr(),
              iconSize: SizeConfig.defaultSize * 5,
